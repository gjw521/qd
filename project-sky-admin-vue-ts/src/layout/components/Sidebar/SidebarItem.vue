    ...
    >
      <template v-if="theOnlyOneChild && !theOnlyOneChild.children">
        ...
        >
          ...
          >
            <!-- <i v-if="theOnlyOneChild.meta.title==='服务台'" class="iconfont icon img-icon-sel" /> -->
            <!-- <svg-icon v-if="theOnlyOneChild.meta.title==='服务台'" name="dashboard" width="20" height="20"></svg-icon> -->
            <i
